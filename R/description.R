              ...
              is mapped to the size and the tooltip shows the context word and its frequency."),
                     ...
                     resets the highlight."))
                        ...
                        column(width = 6,
                               ...
                               #                   ),
                               box(
                                 title = "HDBSCAN structure", status = "success", width = NULL,
                                 p("Violin plots of the", em("eps"), "values per cluster, colored by sense,
                                   and a barplot of the proportions of noise tokens", em("for all medoids"), "."),
                                 p("The eps values are an echo of the tree visualization of HDBSCAN, but segregated by sense.")
                               ),box(
